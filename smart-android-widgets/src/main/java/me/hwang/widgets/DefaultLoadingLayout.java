...
public class DefaultLoadingLayout extends SmartLoadingLayout {
    ...
    DefaultLoadingLayout(Context context, View contentView) {
        ...
        {
            mLoadingView = mInflater.inflate(R.layout.smart_ui_loading_layout_loading_view, null);
            mEmptyView = mInflater.inflate(R.layout.smart_ui_loading_layout_empty_view, null);
            mErrorView = mInflater.inflate(R.layout.smart_ui_loading_layout_error_view, null);
    ...
    public void replaceErrorButton(Button newButton) {
        ...
        lp.topMargin = dip2px(mContext,mContext.getResources().getDimension(R.dimen.smart_ui_loading_layout_error_btn_margin_top));
